...
beautiful_mind = media.Movie("A Beautiful Mind",
                             "From the heights of notoriety to the depths of depravity, John Nash Jr. a mathematical genius experienced it all.",
...
the_imitation_game = media.Movie("The Imitation Game",
                                 "Based on the real life story of legendary cryptanalyst Alan Turing.",
